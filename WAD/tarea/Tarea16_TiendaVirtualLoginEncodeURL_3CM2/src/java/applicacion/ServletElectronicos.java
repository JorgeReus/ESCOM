...
public class ServletElectronicos extends HttpServlet {
    ...
    private List<String> electronicos;

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        HttpSession session = request.getSession();
        ProductsDB prods = new ProductsDB("Electronicos");
        electronicos = prods.getProducts();
        ...
        out.println("<form id=\"prodForm\" method=\"GET\" action=\"ServletElectronicos\">");
